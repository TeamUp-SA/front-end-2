        ...
        <div className="flex h-full flex-col">
          ...
          <div className="border-t border-sidebar-border p-4">
            ...
            <button
              ...
              className="mt-2 flex w-full items-center gap-3 rounded-lg px-3 py-2 text-sm text-sidebar-foreground hover:bg-sidebar-accent/50 transition-colors disabled:opacity-50"
              disabled={isPending}
            >
